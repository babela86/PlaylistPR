...
public class Populate implements Serializable {
	...
	public void populando() throws ParseException, NoSuchAlgorithmException,
		...
		Playlist[] plays = { new Playlist("rafa's playlist", users[1].getIdUtilizador()),
				new Playlist("p's playlist", users[0].getIdUtilizador()) };

		Musica[] musics = {
				new Musica("Lean on", "Major Lazer & DJ Snake",
						"Peace is the Mission", "2015",
						"https://www.youtube.com/watch?v=YqeW9_5kURI", users[0].getIdUtilizador()),
				new Musica("O corpo é que paga", "António Variações",
						"O melhor de António Variações", "1997", "qqcoisa.com", users[0].getIdUtilizador()),
				new Musica("Era só Jajão", "Master Jake", "nao sei", "2014",
						"https://www.youtube.com/watch?v=vMgp904a3nc", users[0].getIdUtilizador()),
				new Musica("Não me Toca", "Anselmo Ralph", "A dor de Cupido",
						"2011",
						"https://www.youtube.com/watch?v=whH2oDg28-k&list=RDwhH2oDg28-k", users[1].getIdUtilizador()),
				new Musica("YMCA", "Village People", "Cruisn", "1978",
						"https://www.youtube.com/watch?v=CS9OO0S5w2k", users[1].getIdUtilizador()),
				new Musica("I wanna Dance with Somebody (Who Loves Me)",
						"Whitney Houston", "Whitney", "1987",
						"https://www.youtube.com/watch?v=eH3giaIzONA", users[1].getIdUtilizador()),
				new Musica("Show das Poderosas", "Anitta", "Nao sei", "2013",
						"https://www.youtube.com/watch?v=FGViL3CYRwg", users[1].getIdUtilizador()),
				new Musica("No woman no cry", "Bob Marley", "Natty Dread",
						"1974", "https://www.youtube.com/watch?v=jGqrvn3q1oo", users[0].getIdUtilizador()) };
