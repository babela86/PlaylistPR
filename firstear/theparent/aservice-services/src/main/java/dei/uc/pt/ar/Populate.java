...
public class Populate implements Serializable {
	...
	public String populando() throws ParseException, NoSuchAlgorithmException,
		...
		Playlist[] plays = { new Playlist("rafa's playlist", users[1]),
				new Playlist("p's playlist", users[0]) };

		Musica[] musics = {
				new Musica("Lean on", "Major Lazer & DJ Snake",
						"Peace is the Mission", "2015",
						"https://www.youtube.com/watch?v=YqeW9_5kURI", users[0]),
				new Musica("O corpo é que paga", "António Variações",
						"O melhor de António Variações", "1997", "qqcoisa.com", users[0]),
				new Musica("Era só Jajão", "Master Jake", "nao sei", "2014",
						"https://www.youtube.com/watch?v=vMgp904a3nc", users[0]),
				new Musica("Não me Toca", "Anselmo Ralph", "A dor de Cupido",
						"2011",
						"https://www.youtube.com/watch?v=whH2oDg28-k&list=RDwhH2oDg28-k", users[1]),
				new Musica("YMCA", "Village People", "Cruisn", "1978",
						"https://www.youtube.com/watch?v=CS9OO0S5w2k", users[1]),
